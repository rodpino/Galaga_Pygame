...
def get_asset_path(*path_parts):
    ...
    return os.path.normpath(os.path.join(asset_dir, *path_parts))
import pygame
import time
...
class Player(pygame.sprite.Sprite):
    def __init__(self, game, sprite_sheet):
        ...
        self.sound_shoot = pygame.mixer.Sound(get_asset_path("sound_shoot_3.wav"))
    ...
    def player_shoot(self):
        laser = Laser(self.rect.center, self.game, self.sprite_sheet)
