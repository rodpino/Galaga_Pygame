            ...
            if current_time - self.last_shot_time > self.shoot_cooldown:
                ...
                if random.random() < 0.1:  # Probabilidad de disparo
                    ...
                    if random.random() < 0.5:  # 50% de disparos precisos
                        laser = AlienLaser(self.rect.center, player_position, self.game, self.sprite_sheet, error_margin=0)
                    else:  # 50% de disparos con variación
                        laser = AlienLaser(self.rect.center, player_position, self.game, self.sprite_sheet, error_margin=75)
