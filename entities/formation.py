...
class Formation:
    ...
    def calculate_target_position(self, mIndex, alien_type):
        ...
        if alien_type == "boss_green":
            ...
            retVal_x = (self.grid_size_x + 20 + self.grid_size_x * 4 * col) * sign
            
            # Asignar la posición en Y para la única fila de alienígenas verdes
            retVal_y = (row * self.grid_size_y - 20)
            print (mIndex)
            ...
            if mIndex // 2 == 0:
                ...
                # Lado derecho
                sign = 1
            col = mIndex // 4  # 0 o 1 para cada par de alienígenas en el lado izquierdo y derecho
            retVal_x = (self.grid_size_x + 20 + self.grid_size_x * 4 * col) * sign
        ...
        #         retVal_y = self.grid_size_y * 0 + 30 # Primera fila
        #     else:
        #         retVal_y = self.grid_size_y * 1 + 520# Segunda fila
        ...
        #         # Lado derecho
        #         sign = 1
        #     print (mIndex, pos_in_group, group)
        #     retVal_x = (self.grid_size_x + 20 + self.grid_size_x * group * 4) * sign

        #     # Ajustar posiciones para la pantalla
        #     screen_x = retVal_x + self.game.settings.WIDTH // 2
        #     screen_y = retVal_y + 280  # Posición objetivo en Y
