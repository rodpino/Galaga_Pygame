...
class Game:
    ...
    def check_for_collision(self):
        ...
        for player in self.player_group.sprites():
            ...
            for laser_sprite in player.laser_group:
...
class Background_2:
    def __init__(self, game):
        ...
        self.toggle_interval = 90  # Intervalo para cambiar entre mitades del fondo
        self.toggle_timer = 0
    ...
    def generate_rects(self, num_rects):
        ...
        for _ in range(num_rects):
            width = random.choice([2, 1])      # Puedes variar los tamaños si quieres
...
class Alien(pygame.sprite.Sprite):
    ...
    def __init__(self,formation, mIndex, alien_type, bezier_id):
...
class Laser (pygame.sprite.Sprite):
    ...
    def __init__(self, position, game ):
        ...
        self.screen = pygame.display.get_surface()
        self.sprite_sheet = game.SPRITE_SHEET  # Reutiliza la hoja de sprites     
        self.image = self.sprite_sheet.subsurface ( 307, 118, self.game.SPRITE_SIZE, self.game.SPRITE_SIZE)
...
class Player(pygame.sprite.Sprite):
    def __init__(self, game):
        ...
        self.sound_shoot = game.sound_shoot  # Usa el sonido ya cargado en Game
        ...
        self.sound_shoot = game.sound_shoot
        self.mask = pygame.mask.from_surface(self.image)
    ...
    def draw(self):
        ...
        for i in range(self.lives):
            self.nave_icono = pygame.transform.scale(self.nave_1, (25 , 25))
            
            x = 10 + i * (self.nave_1.get_width() + 5)
            y = self.game.WINDOW_HEIGHT - 30
            self.screen.blit(self.nave_icono, (x, y))
...
class Formation:
    ...
    def add_aliens_to_group(self, alien_type, count, offset=0):
        ...
        for mIndex in range(count):
            ...
            alien = Alien(self, mIndex + offset, alien_type, bezier_id)
